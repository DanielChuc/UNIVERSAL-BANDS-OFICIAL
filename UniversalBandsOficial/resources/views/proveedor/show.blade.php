                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> NombreCompania </th><td> {{ $proveedor->nombreCompania }} </td></tr><tr><th> NombreContacto </th><td> {{ $proveedor->nombreContacto }} </td></tr><tr><th> CargoContacto </th><td> {{ $proveedor->cargoContacto }} </td></tr>
                                </tbody>
                            </table>
                        </div>
