                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>NombreCompania</th><th>NombreContacto</th><th>CargoContacto</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($proveedor as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->nombreCompania }}</td><td>{{ $item->nombreContacto }}</td><td>{{ $item->cargoContacto }}</td>
                                        <td>
