                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Cliente Id</th><th>Evento Id</th><th>Fecha y Hora de Entrada</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($logentrada as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->cliente_id }}</td><td>{{ $item->evento_id }}</td><td>{{ $item->fechaHoraEntrada }}</td>
                                        <td>
