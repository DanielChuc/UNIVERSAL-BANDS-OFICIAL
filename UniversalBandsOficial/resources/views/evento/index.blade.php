                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Nombre</th><th>Direccion</th><th>Descripcion</th><th>Imagen</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($evento as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->nombreEvento }}</td><td>{{ $item->direccion }}</td><td>{{ $item->descripcion }}</td>
                                        <td>
                                            <img src="{{ url('/UniversalBandsOficial/'.(
                                                isset($item->imagenEvento) ? $item->imagenEvento : 'No_image.png'
                                            ))}}"
                                            height="80px">
                                        </td>
                                        {{-- <img src="{{ url:('imagenes/UniversalBandsOficial - copia/'. $item->imagenEvento : 'No_image.png'
                                        ) }}" height="80px"> --}}
